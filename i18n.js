(() => {
  ...
  const T = {
    de: {
      ...
      'about.text':           'Ausgebildeter Fachinformatiker für Anwendungsentwicklung, 20 Jahre alt, aus Koblenz. Ich baue Backend-Systeme, Shopware 6 Plugins und REST APIs – sauber, wartbar und produktionsreif. Nebenbei entwickle ich eigene Plugins für den Shopware Store und nehme Freelance-Projekte an. Kein Bullshit – nur Code der wirklich funktioniert.',
    ...
    en: {
      ...
      'cta.work':             'View Work',
      'cta.hire':             'Hire Me',
      'about.text':           'Trained IT specialist for application development, 20 years old, based in Koblenz, Germany. I build backend systems, Shopware 6 plugins and REST APIs – clean, maintainable and production-ready. On the side I develop plugins for the Shopware Store and take on freelance projects. No bullshit – just code that actually works.',
