(() => {
  ...
  const T = {
    de: {
      ...
      'exp.1.h1':             'Eigenentwicklung eines koordinatenbasierten Dokument-Viewers – täglich genutzt von mehreren Tausend Archivnutzern',
      'exp.1.h2':             'Integration von Whisper AI zur Transkription von 100.000+ Audiodateien – 85% weniger manuelle Aufwände',
      'exp.1.h3':             'Testautomatisierung mit Selenium & Python',
      ...
      'exp.3.h3':             'SEO & Performance-Optimierungen: ~20% mehr organischer Traffic',
    ...
    en: {
      ...
      'exp.1.h1':             'Built a coordinate-based document viewer used daily by thousands of archive users',
      'exp.1.h2':             'Integrated Whisper AI to transcribe 100,000+ audio files – 85% reduction in manual effort',
      'exp.1.h3':             'Test automation with Selenium & Python',
      ...
      'exp.3.h3':             'SEO & performance optimisations: ~20% more organic traffic',
